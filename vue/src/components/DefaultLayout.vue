      ...
      <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
        ...
        <DisclosurePanel class="md:hidden">
          <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            active-class="bg-gray-900 text-white"
             as="a" :class="[this.$route.name === item.to.name ? '' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'block px-3 py-2 rounded-md text-base font-medium']" >{{ item.name }}</router-link>
          </div>
